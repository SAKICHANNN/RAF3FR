...
Download `RAF3FR-0.9.5-macOS-arm64.zip` from the GitHub Release, expand it and
move `RAF3FR.app` to Applications. The 0.9.5 build supports Apple silicon and
...
Download `RAF3FR-0.9.5-android-arm64.apk` from the GitHub Release and allow your
