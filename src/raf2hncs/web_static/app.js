...
const copy = {
  zh: {
    ...
    distortionModel: "畸变模型", cameraJpeg: "机内 JPEG 匹配", nativeMatch: "厂商 RAW 匹配", legacyInBounds: "旧版无空边",
  ...
  en: {
    ...
    distortionModel: "Distortion model", cameraJpeg: "Camera JPEG match", nativeMatch: "Vendor RAW match", legacyInBounds: "Legacy no-blank-edge",
